...
#### factorialRecursive 0:  ASSIGN int const__1 (= 1)  int res 
	movl $1, -4(%rbp)     # res = 1
#### factorialRecursive 1:  IF_SMALLER_OR_EQUAL int n int const__2 (= 1) 8
	movq 16(%rbp), %r10
	movl $1, %r11d
	cmpl %r11d, %r10d
	jle factorialRecursive_8
...
#### factorialRecursive 5:  GETRETURN   int anon__2 
	movl %eax, -12(%rbp)
#### factorialRecursive 6:  TIMES int n int anon__2 int anon__3 
...
#### factorialRecursive 7:  ASSIGN int anon__3  int res 
	movl -16(%rbp), %r10d
	movl %r10d, -4(%rbp)     # res = anon__3
factorialRecursive_8:
#### factorialRecursive 8:  RETURN int res   
